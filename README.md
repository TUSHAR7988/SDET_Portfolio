...
OR Install Python dependencies (Alternative):
...
Batch files: Edit the port number (5500) in .bat files
package.json: Update port in scripts (5500)
Python script: Change PORT = 5500 in server-with-reload.py
Default Settings
Port: 5500
...
For auto-reload, install watchdog: pip install watchdog
Browser Doesn't Open?
Manually navigate to: http://localhost:5500/index.html

Auto-Reload Not Working?
Make sure you're using START-HERE-WITH-RELOAD.bat or npm run watch
Check that files are saved properly
Try refreshing browser manually (F5)
Check browser console for errors
💡 Tips
For Development: Use auto-reload mode (START-HERE-WITH-RELOAD.bat)
For Testing: Use standard server (START-HERE.bat)
Multiple Servers: Run different ports for multiple projects
